    ...
    <header className='h-[65px] bg-[#1877F2] font-semibold sticky top-0 z-50'>
      <nav className="flex justify-between h-full w-full px-4 sm:p-6 items-center text-white">
        ...
        <div className="w-[30vw]">
          <div className="h-[40px] rounded-full hidden md:flex bg-white px-4 items-center item-center ">
        ...
        <div className='flex gap-6'>
          <div className='flex gap-4 items-center'>
            ...
            <div className='hidden md:flex gap-2 sm:gap-4 items-center text-white'>
